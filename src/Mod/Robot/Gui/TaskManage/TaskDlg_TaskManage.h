...
#include <Mod/Robot/Gui/TaskManage/TaskBox_TaskManager.h>
#include <Mod/Robot/Gui/TaskManage/TaskBox_TracEditPanel.h>
#include <Mod/Robot/Gui/TaskManage/TaskBox_TracSimulator.h>
