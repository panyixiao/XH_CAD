...
bool ProgramSimulator::initDocPtr(App::Document *t_DocPtr)
{
    if(t_DocPtr == nullptr)
        return false;
    m_DocPtr = t_DocPtr;
...
//bool ProgramSimulator::udpateGroupPoseByTime(const double t_Time)
//{
//    if(m_ExecutorPtr == nullptr){
//        Base::Console().Warning("[TracSimulator]udpateGroupPoseByTime(): m_GroupPtr is nullptr!\n");
//        return false;
//    }
//    updatePoseBuffer_ByTime(t_Time);
//    return m_ExecutorPtr->setGroupPose(m_PoseBuffer);
//}

//bool ProgramSimulator::commandFinished(const size_t t_CmdID)
//{
//    if(t_CmdID >= m_MovCmdBuffer.size())
//        return false;
//    auto t_CmmdPtr = m_MovCmdBuffer.at(t_CmdID);
//    m_ExecutorPtr = static_cast<Robot::MechanicGroup*>(m_DocPtr->getObject(t_CmmdPtr->getOperatorName().c_str()));
//    if(m_ExecutorPtr == nullptr){
...
//void ProgramSimulator::updateMovCommandBuffer(const std::vector<RobotCommand_sptr> &t_cmdBuffer)
//{
//    if(t_cmdBuffer.empty())
//        return;
//    m_MovCmdBuffer.clear();
//    m_MovCmdBuffer = t_cmdBuffer;
//    m_ExecutorPtr = static_cast<Robot::MechanicGroup*>(m_DocPtr->getObject(t_cmdBuffer.front()->getOperatorName().c_str()));
//}


//int ProgramSimulator::generateSimulationTrac_FromCurrentPose()
//{
...
//int ProgramSimulator::generateSimulationTrac_FromSelectedCommand(const int s_ID)
//{
//    if(m_TargetProgramPtr == nullptr)
//        return -1;
//    if(m_DocPtr==nullptr)
...
void ProgramSimulator::setTargetSimProgram(const RobotProg_sptr t_Program)
{
    m_TargetProgramPtr = t_Program;
}

const RobotProg_sptr &ProgramSimulator::getCurrentSimProgram() const
{
    return m_TargetProgramPtr;
}

//const std::size_t ProgramSimulator::getMatchedCommandID(const double t_Time,
...
//    m_ExecutorPtr = static_cast<Robot::MechanicGroup*>(m_DocPtr->getObject(executorName.c_str()));
//    if(m_ExecutorPtr == nullptr)
//        return t_CmdID;
...
//    case CommandType::SetMove:{
//        updatePoseBuffer_ByTime(t_Time);
//        m_ExecutorPtr->setGroupPose(m_PoseBuffer);
...
//        m_ExecutorPtr->setCurrentToolActive(t_cmd->getToolStatus());
//        cmd_Finish = true;
//        break;
//    }
//    case CommandType::ChgTool:{
//        auto t_cmd = static_cast<ToolCommand*>(t_CmmdPtr.get());
//        m_ExecutorPtr->setCurrentToolType(t_cmd->getToolType());
//        cmd_Finish = true;
//        break;
//    }
//    default:
...
//bool ProgramSimulator::moveCommandFinished(MoveCommand *t_cmmdPtr)
//{
//    if(m_ExecutorPtr == nullptr)
//        return false;
//    bool reached = true;
...
//    auto c_Pose = m_ExecutorPtr->getCurrentGroupPose(CordType::WCS);
...
//void ProgramSimulator::resetSimulator(void)
//{
//    if(m_ExecutorPtr == nullptr)
//        return;
//    m_ExecutorPtr->setGroupPose(m_InitPose);
//    m_ExecutorPtr->InteractiveTeach.setValue(true);
//}


//const double ProgramSimulator::getDuration(int n) const
//{
//    if(m_SimTracBuffer)
...
const RobotCommand_sptr ProgramSimulator::getSelectedCommandPtr(const size_t t_ID) const
{
    if(m_TargetProgramPtr == nullptr)
        return nullptr;
...
//const TargetPoint_sptr ProgramSimulator::getSelectedCommandPose(const RobotCommand_sptr t_CmdPtr) const
//{
...
const size_t ProgramSimulator::getTotalCommandNumber() const
{
    if(m_TargetProgramPtr == nullptr)
        return 0;
...
const size_t ProgramSimulator::getMoveBufferCommandNum() const
{
    return m_MovCmdBuffer.size();
}

bool ProgramSimulator::executeSelectedCommand(const RobotCommand_sptr t_CmdPtr)
{
    if(t_CmdPtr == nullptr)
        return false;
...
//bool ProgramSimulator::updatePoseBuffer_ByTime(double time)
//{
...
//bool ProgramSimulator::isCommandIDValid(const size_t t_ID)
//{
//    return t_ID<m_TargetProgramPtr->getCmmdData().size();
//}

//bool ProgramSimulator::executeToTime(const double t_Time)
//{
