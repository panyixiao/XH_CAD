...
#include "Mod/Robot/App/Kinematics/kdl_cp/path_jointspace.h"
#include "Mod/Robot/App/Kinematics/kdl_cp/trajectory.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/trajectory_composite.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/trajectory_jointspace.h"

#include "Mod/Robot/App/Kinematics/kdl_cp/chain.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/frames_io.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/chain.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/rotational_interpolation_sa.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/path_roundedcomposite.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/path_line.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/path_point.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/path_circle.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/velocityprofile_trap.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/trajectory_segment.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/trajectory_composite.hpp"
#include "Mod/Robot/App/Kinematics/kdl_cp/utilities/error.h"
...
//class GroupFrame{
//public:
//    GroupFrame(const MechPose& t_Pose){
...
//    const MechPose getGroupPose(const double t) const{
//        MechPose t_Pose;
////        switch(m_Type){
////        case PathType::ComposCart:
////        case PathType::LinerSegment:
...
class RobotExport ProgramSimulator
{
    App::Document* m_DocPtr;
    // Operator
    Robot::MechanicBase* m_ExecutorPtr = nullptr;
    MechPose m_InitPose;
    MechPose m_PoseBuffer;
...
//    const TargetPoint_sptr getSelectedCommandPose(const RobotCommand_sptr t_CmdPtr) const;
