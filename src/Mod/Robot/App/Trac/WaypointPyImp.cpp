...
Py::String WaypointPy::getType(void) const
{
    if(getWaypointPtr()->Type == Waypoint::PTP)
        ...
        throw Base::RuntimeError("Unknown waypoint type! Only: PTP,LIN,CIRC,WAIT are supported.");
}
...
void WaypointPy::setType(Py::String arg)
{
    ...
    if(typeStr=="PTP")
        ...
        throw Base::RuntimeError("Unknown waypoint type! Only: PTP,LIN,CIRC,WAIT are allowed.");
}
