...
PyMOD_INIT_FUNC(FreeCADGui)
{
    try {
        ...
        App::Application::Config()["CopyrightInfo"] = "\xc2\xa9 XH-Robotics 2022\n";
        App::Application::Config()["LicenseInfo"] = "";
        App::Application::Config()["CreditsInfo"] = "Computer-Aided-Metal-processing-System(CAMPS) Makes welding easier!\n";
